        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <center style="color: white;"> Lista de Motos </center>
                        </h2>
                        ...
                        <!-- Se usa para abrir el modal editar, no abre el modal con jQuery x.x -->
                        ...
                        <div class="row clearfix" style="margin-bottom: 15px; margin-top: 5px;">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="input-group" style="margin-bottom: 0px;">
                                    ...
                                    <div class="form-line">
                                        <input type="text" id="buscarEnTablaMotos" class="form-control" placeholder="Buscar por cédula del dueño...">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php include 'app/views/page/moto/modal.php'; ?>
<script src="resources/library/plugins/jquery/jquery.min.js"></script>
<script src="public/js/moto.js"></script>